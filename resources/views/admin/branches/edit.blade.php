...
<div class="container">
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('update-branches' , $branch->id) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-right col-xs-11 ">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input type="text" value="{{ old('total_los_cars') ?? $branch->total_los_cars }}" name="total_los_cars"  class="form-control col-md-7 col-xs-12">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input type="text" value="{{ old('total_los_cars_accedint') ?? $branch->total_los_cars_accedint }}"  name="total_los_cars_accedint"  class="form-control col-md-7 col-xs-12">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('total_los_vans') ?? $branch->total_los_vans }}"  class="form-control col-md-7 col-xs-12" type="text" name="total_los_vans">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input type="text" value="{{ old('total_los_vans_accedint') ?? $branch->total_los_vans_accedint }}"  name="total_los_vans_accedint"  class="form-control col-md-7 col-xs-12">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('total_los_pickups') ?? $branch->total_los_pickups }}" class="form-control col-md-7 col-xs-12" type="text" name="total_los_pickups">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input type="text" value="{{ old('total_los_pickups_accedint') ?? $branch->total_los_pickups_accedint  }}"  name="total_los_pickups_accedint"  class="form-control col-md-7 col-xs-12">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('full_cover_cars') ?? $branch->full_cover_cars }}" class="form-control col-md-7 col-xs-12" type="text" name="full_cover_cars">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('full_cover_cars_per_k') ?? $branch->full_cover_cars_per_k }}" class="form-control col-md-7 col-xs-12" type="text" name="full_cover_cars_per_k">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('full_cover_vans') ?? $branch->full_cover_vans }}" class="form-control col-md-7 col-xs-12" type="text" name="full_cover_vans">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('full_cover_vans_per_k') ?? $branch->full_cover_vans_per_k }}" class="form-control col-md-7 col-xs-12" type="text" name="full_cover_vans_per_k">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('full_cover_pickups') ?? $branch->full_cover_pickups }}" class="form-control col-md-7 col-xs-12" type="text" name="full_cover_pickups">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input value="{{ old('full_cover_pickups_per_k') ?? $branch->full_cover_pickups_per_k }}" class="form-control col-md-7 col-xs-12" type="text" name="full_cover_pickups_per_k">
                    </div>
