            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="x_panel tile fixed_height_320 overflow_hidden">
                        ...
                        <div class="x_content">
                            <table class="___class_+?141___" style="width:100%">
                                <tr>
                                    <th style="width:37%;">
                                        <p>Top 5</p>
                                    </th>
                                    <th>
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                                            <p class="___class_+?143___">Device</p>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                            <p class="___class_+?145___">Progress</p>
                                        </div>
                                    </th>
                                </tr>
                                <tr>
                        ...
                        <div class="x_content">
                            <div class="dashboard-widget-content">
                                ...
                                <div class="sidebar-widget">
                                    ...
                                    <canvas width="150" height="80" id="chart_gauge_01" class="___class_+?177___"
