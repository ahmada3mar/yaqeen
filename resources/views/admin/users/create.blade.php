        ...
        <div class="card-body p-4">
            <form  method="POST" action="{{ route('store-user') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input type="text" name="role" value="{{ old('role') }}"  class="form-control col-md-7 col-xs-12">
                    @if ($errors->has('role'))
                        <span class="text-danger">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                    <input type="text" value="{{ old('email') }}" name="email"  class="form-control col-md-7 col-xs-12">
                    @if ($errors->has('email'))
                        <span class="text-danger">
